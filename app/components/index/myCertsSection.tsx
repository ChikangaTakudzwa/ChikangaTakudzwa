...
const certs = [
  {
    image:
      "https://ivesexid.sirv.com/Portfolio/2024-Portfolio/certs/azure_cert.png",
  ...
  {
    image:
      "https://ivesexid.sirv.com/Portfolio/2024-Portfolio/certs/py4ds_cert.png",
  ...
  {
    image:
      "https://ivesexid.sirv.com/Portfolio/2024-Portfolio/certs/containers_k8s_essen_cert.png",
  ...
  {
    image:
      "https://ivesexid.sirv.com/Portfolio/2024-Portfolio/certs/uplimit_cert.jpeg",
  ...
  {
    image:
      "https://ivesexid.sirv.com/Portfolio/2024-Portfolio/certs/ibm_devops_cert.jpeg",
              ...
              <div className="flex flex-col p-1 mb-8 bg-white border shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70">
                ...
                <div className="p-1">
                  <h3 className="text-lg font-bold text-gray-800 dark:text-white">
                    <span className="text text-xs bg-gray-900 text-white py-1 px-2 rounded-lg">
                      {cert.category}
                    </span>
                    <br />
                    {cert.title}
