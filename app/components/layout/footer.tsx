...
export default function Footer() {
    ...
    return (
        <footer className="text-gray-600 body-font">
                ...
                <div className="flex-grow flex flex-wrap justify-end md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10">
                            ...
                            <li>
                                <a className="text-gray-600 hover:text-gray-800" href={nav.link}>{nav.name}</a>
                            </li>
                            ))}
                        </nav>
                    </div>
            ...
            <div className="bg-gray-100 page-padding">
                <div className="container mx-auto py-4 flex flex-wrap flex-col sm:flex-row">
                <p className="text-gray-500 text-sm text-center sm:text-left">© 2024 OrigamiZimbambwe —
